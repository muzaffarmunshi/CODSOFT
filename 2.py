...
# Functions for the arithmetic operations
def add(x, y):
    return x + y
...
# Creating entry fields for the input numbers and operation
num1_entry = Entry(root)
num2_entry = Entry(root)
operator_entry = Entry(root)
output_entry = Entry(root)

# Creating buttons for the arithmetic operations and clear function
...
# Positioning the widgets on the screen
